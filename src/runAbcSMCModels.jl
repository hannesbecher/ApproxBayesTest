...
println("Model prob: $(results.modelprob)")

writeoutput(results, file="outSMCModels.abc")

savefig(plot(results), "outSMCModels0.png")
for i in 1:3
    savefig(plot(results, i), "outSMCModels$(i).png")
end
println("Done.")